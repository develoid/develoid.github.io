...
function ItemPlaySave() {
  ...
  // 파일 명 생성
  let fileName = "PLAY-FD-"+y+"."+m+"."+d+"-"+h+"."+mm+".json";
...
function Make() {
  ...
  page += "<center>";
  // 상단 테이블 생성
  page += "<div style='display: flex; flex-direction: column; margin-top: -8px; gap: 4px; width: 836px;'>";
  ...
  for(i = 0; i<arrayCNT[num]; i++) {
      page += "<a href='"+temp[i].url+"' target='_blank'><img src='"+temp[i].img+"' style='width: auto; max-height: 48px;'></a>";
  }
  page += "</div>";
  ...
  page += "<tbody>"
  page += "<tr>";
  page += "<td colspan=5 style='text-align: center;'><img src='"+temp[1].img+"' style='width: auto; height: 16px;'></td>";
  page += "</tr>";
  page += "</tbody></table>";
  ...
  page += "<tbody>"
  page += "<tr>";
  page += "<td colspan=5 style='text-align: center;'><img src='"+temp[3].img+"' style='width: auto; height: 16px;'></td>";
  page += "</tr>";
  page += "</tbody></table>";
  ...
  page += "<tbody>"
  page += "<tr>";
  page += "<td colspan=5 style='text-align: center;'><img src='"+temp[4].img+"' style='width: auto; height: 16px;'></td>";
  page += "</tr>";
  page += "</tbody></table>";
  ...
  page += "<tbody>"
  page += "<tr>";
  page += "<td colspan=5 style='text-align: center;'><a href='"+temp[2].url+"' target='_blank'><img src='"+temp[2].img+"' style='width: auto; height: 16px;'></a></td>";
  page += "</tr>";
  page += "</tbody></table>";
  ...
  page += "<div style='display: block; font-size: 0;'><img src='"+temp[5].img+"' style='max-width: auto; max-height: 30px;'></div>";
...
function MakePlay() {
  ...
  num = getTarget('notice');
  for(i = 0; i<arrayCNT[num]; i++) {
      page += "<a href='"+temp[i].url+"' target='_blank'><img src='"+temp[i].img+"' style='max-width: 836px; max-height: auto;'></a>";
  }
  page += "</div>";
  ...
  for(i = 0; i<temp.length; i+=2) {
      ...
      for(j = 0; j<2; j++) {
          //console.log(i, j, i+j);
          page += "<div><a href='"+temp[i+j].url+"' target='_blank'><img src='"+temp[i+j].img+"' style='max-width: 432px; max-height: 162px;'></a></div>";
      }
      page += "</div>";
  }
  ...
  page += "<div style='display: block; font-size: 0;'><img src='"+temp[4].img+"' style='max-width: auto; max-height: 16px;'></div>";
  page += "</div>";
  page += "</div>";
  ...
  for(i = 0; i<temp.length; i+=5) {
      ...
      for(j = 0; j<5; j++) {
          //console.log(i, j, i+j);
          page += "<div style='width: 164px; height: 164px;'><a href='"+temp[i+j].url+"' target='_blank'><img src='"+temp[i+j].img+"' width='164' height='164' style='max-width: 164px; max-height: 164px;'></a></div>";
      }
      page += "</div>";
  }

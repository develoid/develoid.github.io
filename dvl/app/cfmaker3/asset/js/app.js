...
function Make() {
  ...
  page += "<tr>";
  page += "<td width=214><a href='"+temp[0].url+"' target='_blank'><img src='"+temp[0].img+"' style='width: 214px; height: auto; box-shadow: 0px 2px 4px rgb(220, 220, 220);'></a></td>";
  page += "<td width=214><a href='"+temp[1].url+"' target='_blank'><img src='"+temp[1].img+"' style='width: 214px; height: auto; bbox-shadow: 0px 2px 4px rgb(220, 220, 220);'></a></td>";
  page += "<td width=214><a href='"+temp[2].url+"' target='_blank'><img src='"+temp[2].img+"' style='width: 214px; height: auto; box-shadow: 0px 2px 4px rgb(220, 220, 220);'></a></td>";
  page += "<td width=78><a href='"+temp[3].url+"' target='_blank'><img src='"+temp[3].img+"' style='width: 78px; height: auto; box-shadow: 0px 2px 4px rgb(220, 220, 220);'></a></td>";
  page += "<td width=78><a href='"+temp[4].url+"' target='_blank'><img src='"+temp[4].img+"' style='width: 78px; height: auto; box-shadow: 0px 2px 4px rgb(220, 220, 220);'></a></td>";
  page += "</tr>";
